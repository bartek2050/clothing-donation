...
function HomeBeneficiary () {
    return(
        ...
        <div className={"homeBeneficiary__navigation"}>
            <Link to={"/"} className={"homeBeneficiary__navigation-element"}>Fundacjom</Link>
            <Link to={"/"} className={"homeBeneficiary__navigation-element"}>Organizacjom pozarządowym</Link>
            <Link to={"/"} className={"homeBeneficiary__navigation-element"}>Lokalnym zbiórkom</Link>
        </div>
